...
round.starts <- c(game.start.end[1], round.ends + 4)
...
rm(console.data, console.split, data.file, game.start.end, i, kill.data,
   round.ends, round.length, round.starts, round.times, trimmed.kill.data,
   clean.console.df)
